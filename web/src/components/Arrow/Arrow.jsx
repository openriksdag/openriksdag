...
const Arrow = ({index, shownFor, hovered, selected}) => {
  ...
  const label = item =>
    ({
      representative: `${item.first_name} ${item.last_name} signed these motions`,
      motion: `The motion was discussed in:`,
      committee: `The ${item} sent these proposals for decision`,
